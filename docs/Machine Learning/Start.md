...
- The training data is a sequence $(X_1, Y_1), (X_2, Y_2), ..., (X_n, Y_n)$ of i.i.d. pairs with distribution $P$
- An algorithm takes training data as input and outputs $\hat{g_n} = \hat{g_n}((X_1, Y_1), ..., (X_n, Y_n))$
