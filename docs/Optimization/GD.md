...
Please visit [this page](/docs/Code/Optimization/Code%20-%20GD) for a code implementation of the fixed step size gradiant method and [this page](/docs/Code/Optimization/Code%20-%20GD#steepest-gradiant-descent) for a code implementation of the steepest gradiant method.
